...
import { adiantarParcela } from "./adicionarTransacaoEmprestimo.js";
...
editarBtn.addEventListener("click", async () => {
    if(validarDados()){
        ...
        await updateDoc(doc(db, "Emprestimos", $transacaoParaserEditada), {
...
function validarDados(){
    ...
    if(editarSelectParcelas.value <= 0 || editarSelectParcelas.value > 400) return false;
